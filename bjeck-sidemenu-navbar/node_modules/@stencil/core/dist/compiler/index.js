...
function generateJsDocsUsages(config, compilerCtx, dirPath) {
    return __awaiter$1(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const usages = {};
            yield Promise.all(usageFilePaths.map((f) => __awaiter$1(this, void 0, void 0, function* () {
                if (!f.isFile) {
                    return;
                }
...
function createReadme(config, compilerCtx, readmeOutputs, jsonDocs, moduleFile, dirPath, readMePath) {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        const writeFiles = {};
        yield Promise.all(readmeOutputs.map((readmeOutput) => __awaiter$2(this, void 0, void 0, function* () {
...
function generateTypes(config, compilerCtx, buildCtx, pkgData) {
    return __awaiter$5(this, void 0, void 0, function* () {
        ...
        yield Promise.all(srcDtsFiles.map((srcDtsFile) => __awaiter$5(this, void 0, void 0, function* () {
...
function copyTasks(config, compilerCtx, diagnostics, commit) {
    return __awaiter$7(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield Promise.all(copyTasks.map((copyTask) => __awaiter$7(this, void 0, void 0, function* () {
                yield processCopyTasks(config, compilerCtx, allCopyTasks, copyTask);
            })));
            yield Promise.all(allCopyTasks.map((copyTask) => __awaiter$7(this, void 0, void 0, function* () {
...
class InMemoryFileSystem {
    ...
    copyDir(src, dest, opts) {
        return __awaiter$9(this, void 0, void 0, function* () {
            ...
            yield Promise.all(dirItems.map((dirItem) => __awaiter$9(this, void 0, void 0, function* () {
    ...
    removeDir(dirPath) {
        return __awaiter$9(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(dirItems.map((item) => __awaiter$9(this, void 0, void 0, function* () {
    ...
    commitWriteFiles(filesToWrite) {
        return Promise.all(filesToWrite.map((filePath) => __awaiter$9(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
    ...
    commitDeleteFiles(filesToDelete) {
        return Promise.all(filesToDelete.map((filePath) => __awaiter$9(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
...
class WatcherListener {
    ...
    queueCopyTasks() {
        ...
        this.copyTaskTmr = setTimeout(() => __awaiter$11(this, void 0, void 0, function* () {
...
function getBuildContext(config, compilerCtx, watcher) {
    ...
    buildCtx.finish = () => __awaiter$12(this, void 0, void 0, function* () {
        try {
...
function formatComponentConstructorProperty(memberMeta) {
    const property = {};
...
function formatComponentConstructorListeners(listenersMeta) {
...
function generateProxy(namingSet, cmpMeta) {
...
function collectNames(names, namingSet) {
...
function generateComponentTypes(config, compilerCtx, buildCtx, tsOptions, tsHost, tsFilePaths, componentsDtsSrcFilePath) {
    return __awaiter$17(this, void 0, void 0, function* () {
        ...
        const metadata = gatherMetadata(config, compilerCtx, buildCtx.diagnostics, buildCtx.collections, checkProgram.getTypeChecker(), checkProgram.getSourceFiles());
        ...
        yield Promise.all(typesOutputTargets.map((outputTarget) => __awaiter$17(this, void 0, void 0, function* () {
...
function scanDirForTsFiles(config, fs, dir) {
    return __awaiter$19(this, void 0, void 0, function* () {
        ...
        yield Promise.all(tsFileItems.map((tsFileItem) => __awaiter$19(this, void 0, void 0, function* () {
...
function versionElementAssets(config, compilerCtx, outputTarget, windowLocationHref, doc) {
    return __awaiter$22(this, void 0, void 0, function* () {
        ...
        yield Promise.all(ELEMENT_TYPES.map((elmType) => __awaiter$22(this, void 0, void 0, function* () {
    ...
    return __awaiter$23(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (Array.isArray(manifest.icons)) {
                yield Promise.all(manifest.icons.map((manifestIcon) => __awaiter$23(this, void 0, void 0, function* () {
...
function h(nodeName, vnodeData, child) {
    ...
    if (typeof nodeName === 'function') {
        ...
        return nodeName(Object.assign({}, vnodeData, { children: children }));
    }
    return {
        vtag: nodeName,
        vchildren: children,
...
function loadHostContent(domApi, contentRef, contentSlots, node, childNodes, i, slotName) {
    ...
    if (node) {
        ...
        for (i = 0; i < childNodes.length; i++) {
            node = childNodes[i];
            if (domApi.$nodeType(node) === 1 /* ElementNode */ && isDef(slotName = domApi.$getAttribute(node, 'slot'))) {
                // is element node
...
function createRendererPatch(plt, domApi) {
    ...
    function patchVNode(oldVNode, newVNode, defaultHolder) {
        ...
        if (Build.hasSvg) {
            ...
            isSvgMode = newVNode.elm && isDef(domApi.$parentElement(newVNode.elm)) && newVNode.elm.ownerSVGElement !== undefined;
    ...
    let contentSlots, useNativeShadowDom, ssrId, scopeId;
...
function hydrateHtml(config, compilerCtx, outputTarget, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$31(this, void 0, void 0, function* () {
            if (config._isTesting) {
...
function prerenderOutputTargets(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter$35(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$35(this, void 0, void 0, function* () {
...
function emptyOutputTargetDirs(config, compilerCtx) {
    return __awaiter$37(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$37(this, void 0, void 0, function* () {
...
function generateCoreEsm(config, compilerCtx, buildCtx, outputTarget, entryModules, appRegistry) {
    return __awaiter$50(this, void 0, void 0, function* () {
        // esm core build
        ...
        const coreFilename = yield generateCore(config, compilerCtx, buildCtx, outputTarget, globalJsContentsEsm, buildConditionals);
        appRegistry.core = coreFilename;
    });
}
function generateCoreEs5(config, compilerCtx, buildCtx, outputTarget, entryModules, appRegistry) {
    return __awaiter$50(this, void 0, void 0, function* () {
        if (config.buildEs5) {
            // core es5 build
...
function generateBundles(config, compilerCtx, buildCtx, entryModules, jsModules) {
    return __awaiter$51(this, void 0, void 0, function* () {
        ...
        const bundleKeys = {};
        yield Promise.all(entryModules.map((entryModule) => __awaiter$51(this, void 0, void 0, function* () {
            ...
            return Promise.all(entryModule.modeNames.map((modeName) => __awaiter$51(this, void 0, void 0, function* () {
        ...
        const esmPromises = Object.keys(esmModules)
            ...
            .map(([key, value]) => __awaiter$51(this, void 0, void 0, function* () {
...
function generateBundleBuild(config, compilerCtx, entryModule, jsText, bundleId, modeName, isScopedStyles, sourceTarget) {
    return __awaiter$51(this, void 0, void 0, function* () {
        ...
        return Promise.all(outputTargets.map((outputTarget) => __awaiter$51(this, void 0, void 0, function* () {
...
function generateStyles(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter$52(this, void 0, void 0, function* () {
        ...
        yield Promise.all(entryModules.map((bundle) => __awaiter$52(this, void 0, void 0, function* () {
            yield Promise.all(bundle.moduleFiles.map((moduleFile) => __awaiter$52(this, void 0, void 0, function* () {
...
function generateComponentStyles(config, compilerCtx, buildCtx, moduleFile) {
    return __awaiter$52(this, void 0, void 0, function* () {
        ...
        yield Promise.all(Object.keys(stylesMeta).map((modeName) => __awaiter$52(this, void 0, void 0, function* () {
...
function compileExternalStyle(config, compilerCtx, buildCtx, moduleFile, extStylePath) {
    return __awaiter$52(this, void 0, void 0, function* () {
        ...
        if (!moduleFile.isCollectionDependency) {
            ...
            yield Promise.all(collectionDirs.map((outputTarget) => __awaiter$52(this, void 0, void 0, function* () {
    ...
    return __awaiter$58(this, void 0, void 0, function* () {
        const promises = Object.keys(results).map((moduleType) => {
            ...
            const promises = Object.keys(jsModuleList)
                ...
                .map((chunk) => __awaiter$58(this, void 0, void 0, function* () {
...
function createDoUpgrade(config, compilerCtx, buildCtx) {
    return (collection, upgrades) => __awaiter$60(this, void 0, void 0, function* () {
        ...
        yield Promise.all(collection.moduleFiles.map((moduleFile) => __awaiter$60(this, void 0, void 0, function* () {
            try {
...
function initCollections(config, compilerCtx, buildCtx) {
    return __awaiter$61(this, void 0, void 0, function* () {
        ...
        return Promise.all(uninitialized.map((collection) => __awaiter$61(this, void 0, void 0, function* () {
